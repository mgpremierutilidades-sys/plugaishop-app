...
export const products: Product[] = [
  {
    ...
    description:
      "Mantém o balcão da loja livre de fios e facilita a rotina de reposição.",
    category: "Operação",
    price: 79.9,
    image:
  ...
  },
  {
    ...
    description:
      "Expõe promoções de forma elegante e aumenta o ticket médio na saída.",
  ...
  },
  {
    ...
    description:
      "Envelopes e etiquetas com a marca PlugaiShop para reforçar o pós-venda.",
    category: "Branding",
    price: 119.5,
    image:
  ...
  },
  {
    ...
    description:
      "Reduz filas no caixa e ajuda clientes a consultar estoque em minutos.",
  ...
  },
  {
    ...
    description:
      "Notifica a equipe sobre variações de demanda e evita ruptura de gôndola.",
    category: "Operação",
    price: 329.0,
    image:
