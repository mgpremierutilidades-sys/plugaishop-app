...
function reducer(state: CartState, action: Action): CartState {
  switch (action.type) {
    case "HYDRATE": {
      // Merge defensivo (anti-race): ao iniciar o app, HYDRATE pode chegar depois de um ADD feito "rápido".
      // Se fizermos replace puro, pisoteamos o item recém-adicionado. Aqui fazemos merge por updatedAt.
      ...
      for (const [id, cur] of Object.entries(current)) {
        ...
        // Preferir o mais recente; em empate, preserva o atual (evita regressão de qty)
