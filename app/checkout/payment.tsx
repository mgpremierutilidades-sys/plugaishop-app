...
type PaymentId = "pix" | "credit_card" | "boleto";
...
export default function CheckoutPayment() {
  ...
  const options: PaymentOption[] = useMemo(
    () => [
      { id: "pix", title: "Pix", desc: "Aprovação imediata" },
      { id: "credit_card", title: "Cartão de crédito", desc: "Parcelamento disponível" },
      { id: "boleto", title: "Boleto", desc: "Compensação em até 2 dias úteis" },
    ],
    []
  );

  const [selectedId, setSelectedId] = useState<PaymentId>("pix");

  async function persistPaymentAndContinue() {
    ...
    <SafeAreaView style={styles.safe} edges={["top", "left", "right"]}>
      <ThemedView style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <Pressable onPress={persistPaymentAndContinue} style={styles.primaryBtn} accessibilityRole="button">
