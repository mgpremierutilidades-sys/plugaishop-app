...
export default function CartScreen() {
  ...
  const sections = useMemo<Section[]>(() => {
    const recos: RecommendationRow[] = (products as Product[])
      ...
      .slice(0, 6)
      // ✅ FIX: força literal type para "reco"
      .map(
        (p): RecommendationRow => ({
          type: "reco",
        ...
        <SectionList
          ...
          ListEmptyComponent={
            <ThemedView style={styles.emptyBox}>
              ...
              <ThemedText style={styles.emptyText}>Adicione produtos para continuar.</ThemedText>
            </ThemedView>
          }
        />
              ...
              <View style={styles.cepRow}>
                ...
                <Pressable
                  onPress={() => {
                    ...
                    Alert.alert(
                      "Frete",
                      `Estimativa: ${shippingEstimated <= 0 ? "Grátis" : formatCurrency(shippingEstimated)}`
                    );
                  }}
                  style={styles.cepBtn}
                >
...
const styles = StyleSheet.create({
  ...
  emptyTitle: { fontFamily: FONT_TITLE, fontSize: 16, fontWeight: "700", color: theme.colors.text },
  emptyText: { fontFamily: FONT_BODY, fontSize: 12, color: "rgba(0,0,0,0.6)" },
